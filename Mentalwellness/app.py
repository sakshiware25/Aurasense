...
st.markdown("""
    ...
    .download-btn:hover {
        background-color:rgb(130, 172, 224);
        color: #fff;
    }
    </style>
...
# Main interface
st.markdown("<div class='title-card'>AuraSense: Your AI Mood Journal 🌈</div>", unsafe_allow_html=True)
...
if st.session_state.page == "home":
    st.markdown("### Welcome to AuraSense!")
